...
const ProjectSection = () => {
  ...
  return (
    <section className="mt-12 px-10 mb-10">
      <h2 className="text-3xl md:text-4xl text-center uppercase mb-5 md:mb-1">Featured Projects</h2>
      <p className="opacity-75 text-center">Here are some of the projects I worked on:</p>
          ...
          >
            ...
            >
              ...
              <div className="px-5 py-4 flex flex-col gap-2 text-gray-200">
                ...
                <p className="text-xs italic text-gray-400 -mt-2">{showCard.category}</p>
                <div>
                  <h5 className="text-gray-200 mb-1">Description:</h5>
                  <p className="text-xs opacity-80 font-extralight">{showCard.longDesc}</p>
                </div>
                <div>
                  <h5 className="text-gray-200 mb-1">Built With:</h5>
                  <p className="text-xs font-extralight opacity-80">{showCard.built}</p>
                </div>
